module github.com/olaysco/langchaingo
...
//   - import "github.com/olaysco/langchaingo/llms/openai" → only OpenAI-related deps
//   - import "github.com/olaysco/langchaingo/vectorstores/chroma" → only Chroma deps
